 ...
 */
@WebServlet("/mypage/deleteActorWishlist")
public class DeleteActorWishlistServlet extends HttpServlet {
...
//			}
			...
			int result = mypageService.deleteWishActors(memberId, deleteArr);
