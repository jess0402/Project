 ...
 */
@WebServlet("/mypage/deleteWishlistAnn")
public class DeleteAnnWishlistServlet extends HttpServlet {
...
//			}
			...
			int result = mypageService.deleteWishAnns(deleteArr, memberId);
