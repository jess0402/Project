...
<details open="open">
  ...
  <ol>
    ...
    <li><a href="#구현-기능">구현 기능</a>
      <ul>
        <li><a href="#notice">배우 마이페이지 - 포트폴리오 등록 CRUD</a></li>
        <li><a href="#notice">배우 마이페이지 - 지원한 공고 확인</a></li>
        <li><a href="#event">캐스팅 디렉터 마이페이지 - 내 공고 확인</a></li>
        <li><a href="#event">캐스팅 디렉터 마이페이지 - 지원자 확인</a></li>
        <li><a href="#event">캐스팅 디렉터 마이페이지 - 담당자 정보 CRUD</a></li>
        <li><a href="#faq">마이페이지 공통기능 - 내가 쓴 게시글</a></li>
        <li><a href="#faq">마이페이지 공통기능 - 찜 목록</a></li>
        <li><a href="#faq">마이페이지 공통기능 - 회원정보 수정</a></li>
        <li><a href="#faq">마이페이지 공통기능 - 회원 탈퇴</a></li>
        <li><a href="#inquiry">관리자 기능 - 회원 관리</a></li>
        <li><a href="#inquiry">관리자 기능 - 신고내역 관리</a></li>
      </ul>
    </li>
  </ol>
</details>
